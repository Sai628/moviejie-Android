...
import com.sai628.moviejie.viewadapter.CommonAdapter.OnViewInflateListener;
...
public class ViewHolderHelper
{
    ...
    private ViewHolderHelper(Context context, ViewGroup parent, int layoutId, int position, OnViewInflateListener listener)
    {
        ...
        if (listener != null)
        {
            listener.onInflate(mConvertView);
        }
    ...
    {
        return setText(viewId, mContext.getResources().getText(textResId));
    }
    ...
    {
        return setHint(viewId, mContext.getResources().getText(textResId));
    }
