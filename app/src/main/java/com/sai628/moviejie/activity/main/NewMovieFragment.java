...
/**
 * @author Sai
 * @ClassName: NewMovieFragment
 * @Description: "最新电影"视图
 * @date 09/05/2018 16:58
 */
public class NewMovieFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate, LoadingMenu.OnRetryClickListener
{
    ...
    {
        NetService.getNewMovie(getActivity(), "p1", new NetHelper.NetCallback()
        {
            @Override
    ...
    {
        NetService.getNewMovie(getActivity(), "p" + currentPage, new NetHelper.NetCallback()
        {
            @Override
            public void onSuccess(Object data)
            {
